/* packages are named in lower case */
package com.hillel.language.basis;

/**
 * Simple class that shows java naming conventions.
 *
 * Class names always starts with upper case letter and written, preferably, in camel-case
 */
